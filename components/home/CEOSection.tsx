          ...
          >
            ...
            <div className="space-y-3 mb-6">
              <div className="flex items-start">
                <GraduationCap className="h-5 w-5 text-[#0052CC] mr-3 mt-1 flex-shrink-0" />
                <p className="text-gray-700">早稲田大学社会科学部卒業</p>
              </div>
              <div className="flex items-start">
                <Briefcase className="h-5 w-5 text-[#0052CC] mr-3 mt-1 flex-shrink-0" />
                <p className="text-gray-700">19歳からWebマーケティングを開始し、成果報酬型WEB広告代理店を創業</p>
              </div>
              <div className="flex items-start">
                <Award className="h-5 w-5 text-[#0052CC] mr-3 mt-1 flex-shrink-0" />
                <p className="text-gray-700">47期続く建設・産業廃棄物処理会社の家系</p>
              </div>
            </div>

            <p className="text-gray-700 mb-4">
              物心がつく前から建設業界の空気を肌で感じて育ちました。広告代理店を運営するなかで、他業種の成果報酬型人材獲得のための広告運用に携わる機会を得ました。そこで気づいたのは、建設業界における深刻な人材不足の問題と、既存の人材配置の非効率さでした。
            </p>
            <p className="text-gray-700">
              優秀な施工管理技術者が必ずしも適材適所で活躍できていない現状を目の当たりにし、私はWebマーケティングとAIの技術を駆使することで、この状況を打破できると確信しました。
            </p>
          </motion.div>
        </div>
